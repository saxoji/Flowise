import { applyVisibleInputDefaults, showHideInputs, syncNodeInputsWithEdges } from './genericHelper'
...
describe('syncNodeInputsWithEdges', () => {
    ...
    it('removes stale tool refs that no longer have edges', () => {
        ...
        const edges = [{ source: 'customTool_0', target: 'toolAgent_0', targetHandle: 'toolAgent_0-input-tools-Tool' }]
    ...
    it('syncs single connected input anchors without touching input params', () => {
        ...
        const edges = [{ source: 'chatOpenRouter_0', target: 'toolAgent_0', targetHandle: 'toolAgent_0-input-model-BaseChatModel' }]
